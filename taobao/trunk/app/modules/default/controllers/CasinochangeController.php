...
class CasinochangeController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        //$userInfo['point'] = Bll_Cache_Casino_Casino::getUserPoint($uid);
    ...
    public function changeAction()
    {
		...
		$changetype = $this->_request->getParam ('changetype');
    	//change point
        $result = Hapyfish2_Island_Event_Bll_Casino::changeCasino($uid, $point, $itemid, $changetype);
