...
class MaintenanceapiController extends Zend_Controller_Action
{
	...
	{
		$btl_id = $this->_request->getParam('btl_id','0,1,2,3,4,5,6,7');
	...
	public function loadlocalshipAction()
	{
		$key = 'island:shiplist';
		$cache = Hapyfish2_Island_Cache_BasicInfo::getBasicMC();
		$list = $cache->get($key);
	...
	public function loadcompoundAction()
	{
		$list = Hapyfish2_Island_Cache_Compound::loadBasicInfo();
		$this->echoResult($list);
	}
	
	public function loadlocalcompoundAction()
	{
		$key = 'i:b:c:bm';
	...
	public function loadcompoundconfigAction()
	{
		$list = Hapyfish2_Island_Cache_Compound::loadUpdateconfig();
		$this->echoResult($list);
	}
	public function loadlocalcompoundconfigAction()
	{
		$key = 'i:b:c:bm:c';
		$cache = Hapyfish2_Island_Cache_Compound::getBasicMC();
		$list = $cache->get($key);
	...
	public function loadresolveAction()
	{
		$list = Hapyfish2_Island_Cache_Compound::loadResolveConfig();
		$this->echoResult($list);
	}
	public function loadlocalresolveAction()
	{
		$key = 'i:b:c:bm:r';
		$cache = Hapyfish2_Island_Cache_Compound::getBasicMC();
		$list = $cache->get($key);
	...
	public function getcompoundlistAction()
	{
		$data = Hapyfish2_Island_Bll_BasicInfo::getCompoundList();
		$this->echoResult($data);
	}
	
	public function loadmarketAction()
	{
		$list = Hapyfish2_Island_Cache_Compound::loadMarket();
		$this->echoResult($list);
	}
	public function loadlocalmarketAction()
	{
		$key = 'i:b:c:bm:m';
		$cache = Hapyfish2_Island_Cache_Compound::getBasicMC();
		$list = $cache->get($key);
    ...
    public function loadsvinfoAction()
    {
        Hapyfish2_Island_Cache_BasicInfo::loadSVDemandList();
        Hapyfish2_Island_Cache_BasicInfo::loadSVisitorList();
        Hapyfish2_Island_Cache_BasicInfo::loadCollectionList();
        Hapyfish2_Island_Cache_BasicInfo::loadCollectionGroups();
        Hapyfish2_Island_Cache_BasicInfo::loadCollectionRandArray();
        $data = array('ok');
        $this->echoResult($data);
    }
    
    public function loadlocalsvinfoAction()
    {
        $cache = Hapyfish2_Island_Cache_BasicInfo::getBasicMC();
