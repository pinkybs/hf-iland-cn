...
class Hapyfish2_Island_Bll_SuperVisitor
{
	public static function getSuperVisitor($uid, $ownerUid = null)
	{
		//接待自己家游客
		if ( !$ownerUid || $uid == $ownerUid ) {
			$svInfo = Hapyfish2_Island_Cache_SuperVisitor::get($uid);
			$result = self::getSVInfo($svInfo);
		}//偷取好友家游客
		else {
			$svInfo = Hapyfish2_Island_Cache_SuperVisitor::getMoochSVInfo($ownerUid);
	...
	public static function updateSuperVisitor($uid, $sid)
	{
        ...
        /*$remainSvNum = Hapyfish2_Island_Cache_SuperVisitor::getTodayRemainSvNum($uid);
        if ( $remainSvNum > 0 ) {
        ...
        if ( !empty($newSuperVisitor) ) {
			//update
			Hapyfish2_Island_Cache_SuperVisitor::add($uid, $newSuperVisitor);
	...
	public static function updateMoochSuperVisitor($uid, $ownerUid, $pid)
	{
		...
		//update
		Hapyfish2_Island_Cache_SuperVisitor::addMoochSvInfo($ownerUid, $newSuperVisitor);
	...
	public static function getSuperVisitorGift($uid, $id)
	{
		...
		if ( !isset($svData[2]) ) {
			...
			try {
				...
				Hapyfish2_Island_Cache_SuperVisitor::updateTodayRemainSvNum($uid, $newSvNum);
		...
		//update
		Hapyfish2_Island_Cache_SuperVisitor::update($uid, $svInfo);
	...
	public static function getMoochSuperVisitorGift($uid, $ownerUid, $id)
	{
		...
		//update
		Hapyfish2_Island_Cache_SuperVisitor::updateMoochSvInfo($ownerUid, $svInfo);
		$resultVo['result']['status'] = 1;
	...
	{
		$lstColn = Hapyfish2_Island_Cache_SuperVisitor::getUserCollection($uid);
	...
	public static function getSvGift($uid)
	{
        ...
        //获取收集物品相关信息
        $collectionInfo = Hapyfish2_Island_Cache_SuperVisitor::getSvGiftById($giftId);
        $cid = $collectionInfo['cid'];
        
        $count = 1;
        //check user collection count
        $userTodayColnList = Hapyfish2_Island_Cache_SuperVisitor::getUserTodayCollection($uid);
        ...
        if ( $ok ) {
            ...
            Hapyfish2_Island_Cache_SuperVisitor::updateUserTodayCollection($uid, $userTodayColnList);
	...
	public static function getNewCollection($uid)
	{
		...
		$ok = Hapyfish2_Island_Cache_SuperVisitor::addUserCollection($uid, $cid, $count);
		if ( $ok ) {
			if ( isset($userTodayColnList[$cid]) ) {
				$userTodayColnList[$cid]['count'] += $count;
			}
	...
	public static function changeCollection($uid, $gid)
	{
		...
		try {
			...
			//扣除收集物品
			Hapyfish2_Island_Cache_SuperVisitor::updateUsercollection($uid, $userCollection, true);
	...
	public static function getSuperVisitorNumBySid($sid)
	{
		...
		$array = array(
					'1' => array('sMinNum' => 1, 'sMaxNum' => 3, 'nNum1' => 0, 'nNum2' => 0, 'nNum3' => 0, 'npro1' => 100, 'npro2' => 0, 'npro3' => 0),
				    '2' => array('sMinNum' => 2, 'sMaxNum' => 3, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 0, 'npro1' => 50, 'npro2' => 100, 'npro3' => 0),
				    '3' => array('sMinNum' => 3, 'sMaxNum' => 4, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 0, 'npro1' => 50, 'npro2' => 100, 'npro3' => 0),
				    '4' => array('sMinNum' => 3, 'sMaxNum' => 4, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 0, 'npro1' => 50, 'npro2' => 100, 'npro3' => 0),
				    '5' => array('sMinNum' => 3, 'sMaxNum' => 5, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 0, 'npro1' => 50, 'npro2' => 100, 'npro3' => 0),
				    '6' => array('sMinNum' => 3, 'sMaxNum' => 5, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 2, 'npro1' => 50, 'npro2' => 75, 'npro3' => 100),
				    '7' => array('sMinNum' => 6, 'sMaxNum' => 7, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 2, 'npro1' => 50, 'npro2' => 75, 'npro3' => 100),
				    '8' => array('sMinNum' => 6, 'sMaxNum' => 7, 'nNum1' => 0, 'nNum2' => 1, 'nNum3' => 2, 'npro1' => 50, 'npro2' => 75, 'npro3' => 100)
				);
		$randData = $array[$sid];
		$result = array();
