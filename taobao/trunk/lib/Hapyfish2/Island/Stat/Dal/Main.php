...
class Hapyfish2_Island_Stat_Dal_Main
{
    ...
    public function getDay($day)
    {
    	...
    	$sql = "SELECT log_time,total_count,add_user,add_user_male,add_user_female,active,active_male,active_female,send_gold FROM $tbname WHERE log_time=:day";
