...
class Hapyfish2_Island_HFC_Achievement
{
    ...
    public static function saveUserAchievement($uid, $achievement)
    {
    	...
    	$data = array(
    		...
    		$achievement['num_41'],$achievement['num_42'],$achievement['num_57'],$achievement['num_58'],$achievement['num_59'],
    		$achievement['num_60'],$achievement['num_61'],$achievement['num_62']
    	);
    		...
    		if ($ok) {
				try {
					$info = array(
						...
						'num_57' => $achievement['num_57'],'num_58' => $achievement['num_58'],'num_59' => $achievement['num_59'],
						'num_60' => $achievement['num_60'], 'num_61' => $achievement['num_61'], 'num_62' => $achievement['num_62']
