...
class Hapyfish2_Island_Dal_BasicInfo
{
    ...
    {
    	$sql = "SELECT cid,name,class_name,content,add_praise,price,price_type,sale_price,need_level,nodes,item_type,item_id,new,can_buy,ticket,pay_time,safe_time,safe_coin_num,need_praise,level,next_level_cid,cheap_price,cheap_start_time,cheap_end_time,act_name FROM island_plant";
    ...
    public function getSVDemandList()
    {
        $sql = "SELECT id,name,content,needs,awards FROM island_sv_demand";
    ...
    public function getSVisitorList()
    {
        $sql = "SELECT cid,name,body_class,face_class FROM island_sv_visitor";
        
        $db = $this->getDB();
        $rdb = $db['r'];
        
        $result = $rdb->fetchAll($sql);
        return $result;
    }
    
    public function getCollectionList()
    {
        $sql = "SELECT cid,name,class_name,group_id,odds,max_num FROM island_sv_collection";
    ...
    {
        $sql = "SELECT gid,needs,awards FROM island_sv_collection_group";
    ...
    public function getSvGiftList()
    {
        $sql = "SELECT id,cid,type,odds,max_num FROM island_sv_gift";
    ...
    public function getCompoundSvGiftList()
    {
        $sql = "SELECT id,cid,type,odds,max_num FROM island_sv_compound_gift";
