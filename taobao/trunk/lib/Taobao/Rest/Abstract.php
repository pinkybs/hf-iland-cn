...
class Taobao_Rest_Abstract
{
    ...
    public function call_method($method, $params)
    {
        ...
        if (is_array($result) && isset($result['code'])) {
            throw new Taobao_Rest_Exception('[' . $method . ']:' . $result['msg'], $result['code']);
        }
...
//if ($method == 'taobao.jianghu.albums.getAlbumList') {
//info_log($this->server_addr . '?' . $post_string, 'testapigetAlbumList');
//}
...
//if ($method == 'taobao.jianghu.albums.getAlbumList') {
//info_log($result, 'testapigetAlbumList');
//}
        //echo $result;
        //print_r($result);
        return $result;
