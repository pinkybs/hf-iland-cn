...
require_once 'Xiaonei/Rest/Exception.php';
...
class Xiaonei_Rest
{
    ...
    public function users_getInfo($uids, $fields = null)
    {
        ...
        return $this->call_method('xiaonei.users.getInfo', $params);
    }
    ...
    public function users_hasAppPermission($ext_perm, $uid = null)
    {
        ...
        return $this->call_method('xiaonei.users.hasAppPermission', $params);
    }
    ...
    public function users_isAppUser($uid = null)
    {
        ...
        return $this->call_method('xiaonei.users.isAppUser', $params);
    }
    ...
    public function friends_get($page = 0, $count = 1000)
    {
        ...
        return $this->call_method('xiaonei.friends.get', $params);
    }
    ...
    {
        $params = array('page' => $page, 'count' => $count);
        return $this->call_method('xiaonei.friends.getFriends', $params);
    }
    ...
    {
        return $this->call_method('xiaonei.friends.getAppUsers', array());
    }
    ...
    public function friends_getAppFriends($fields = null)
    {
        ...
        return $this->call_method('xiaonei.friends.getAppFriends', $params);
    }
    ...
    public function friends_areFriends($uids1, $uids2)
    {
        ...
        return $this->call_method('xiaonei.friends.areFriends', $params);
    }

    public function feed_publishTemplatizedAction($template_id, $title_data, $body_data)
    {
        $params = array('template_id' => $template_id, 'title_data' => $title_data, 'body_data' => $body_data);
        return $this->call_method('xiaonei.feed.publishTemplatizedAction', $params);
    }

    public function notifications_send($to_ids, $notification)
    {
        $params = array('to_ids' => $to_ids, 'notification' => $notification);
        return $this->call_method('xiaonei.notifications.send', $params);
    }

    public function admin_getAllocation()
    {
        return $this->call_method('xiaonei.admin.getAllocation', array());
    }

    public function pay_isCompleted($order_id)
    {
        $params = array('order_id' => $order_id);
        return $this->call_method('xiaonei.pay.isCompleted', $params);
    }

    public function pay_regOrder($order_id, $amount, $desc, $type = 0)
    {
        $params = array('order_id' => $order_id, 'amount' => $amount, 'desc' => $desc, 'type' => $type);
        return $this->call_method('xiaonei.pay.regOrder', $params);
    }

    public function pay4Test_isCompleted($order_id)
    {
        $params = array('order_id' => $order_id);
        return $this->call_method('xiaonei.pay4Test.isCompleted', $params);
    }

    public function pay4Test_regOrder($order_id, $amount, $desc, $type = 0)
    {
        $params = array('order_id' => $order_id, 'amount' => $amount, 'desc' => $desc, 'type' => $type);
        return $this->call_method('xiaonei.pay4Test.regOrder', $params);
    }
    ...
    public function call_method($method, $params)
    {
        ...
        if (is_array($result) && isset($result['error_code'])) {
            ...
            throw new Xiaonei_Rest_Exception($error_msg, $result['error_code']);
        }
    ...
    public function post_request($method, $params)
    {
        ...
        $ua = 'PHP-cURL/' . $cURLVersion['version'] . ' HapyFish-XNRest/1.0';
        ...
        if ($errno != CURLE_OK) {
            throw new Xiaonei_Rest_Exception("HTTP Error: " . $error, $errno);
        }
