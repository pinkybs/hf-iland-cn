...
class Hapyfish2_Island_Dal_User
{
    ...
    public function getUserInfoAll($uid)
    {
		$tbname = $this->getTableName($uid);
    	$sql = "SELECT uid,coin,gold,`exp`,`level`,island_level,last_login_time,active_login_count,max_active_login_count,all_login_count,star_login_count,starfish FROM $tbname WHERE uid=:uid";
