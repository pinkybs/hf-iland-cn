...
class Hapyfish2_Island_Dal_BasicInfo
{
    ...
    {
    	$sql = "SELECT cid,name,class_name,add_praise,price,price_type,sale_price,need_level,nodes,item_type,item_id,new,can_buy,ticket,pay_time,safe_time,safe_coin_num,need_praise,level,next_level_cid,cheap_price,cheap_start_time,cheap_end_time FROM island_plant";
    ...
    {
    	$sql = "SELECT level,need_user_level,island_size,max_visitor FROM island_level_island";
    ...
    {
    	$sql = "SELECT level,cid,name FROM island_level_gift";
    ...
    {
    	$sql = "SELECT level,coin,gold,item_id,item_num FROM island_level_gift_step";
