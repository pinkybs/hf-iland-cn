 ...
 * Draw a hollow dot
 */
class OFC_Charts_Dot_Hollow extends OFC_Charts_Dot_Base
{
	function OFC_Charts_Dot_Hollow( $value=null )
    {
 ...
 * Draw a star
 */
class OFC_Charts_Dot_Star extends OFC_Charts_Dot_Base
{
	function OFC_Charts_Dot_Star( $value=null )
    {
 ...
 */
class OFC_Charts_Dot_Bow extends OFC_Charts_Dot_Base
{
	function OFC_Charts_Dot_Bow( $value=null )
    {
 ...
 */
class OFC_Charts_Dot_Anchor extends OFC_Charts_Dot_Base
{
	function OFC_Charts_Dot_Anchor( $value=null )
    {
 ...
 * A simple dot
 */
class OFC_Charts_Dot_Solid extends OFC_Charts_Dot_Base
{
	function OFC_Charts_Dot_Solid( $value=null )
    {
