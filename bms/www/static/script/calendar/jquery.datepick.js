...
function Datepick() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonImage: '/static/image/dateorg.gif', // URL for trigger button image
...
$.extend(Datepick.prototype, {
	...
	_setDateFromField: function(inst) {
		...
		var beforeSetDate=this._get(inst, 'beforeSetDate');
		if(beforeSetDate) dates=beforeSetDate.apply(this,[inst.lastVal]);
...
// 兼容样式选择:add by pluto --2009/08/27
$().ready(function(){
	$(".DateMonthPicker").datepick( 
    {
        beforeSetDate: function(date) 
    	{  
    		date+='-01';
    		return date;
    	}
    	...
    	{ 
    		var theMonth = arguments[1] < 10 ? '0'+arguments[1] : arguments[1];
    		var oldMonth = this.value.substring(5,7);
    		if(theMonth!=oldMonth)
    		{
        		this.value = arguments[0]+'-'+theMonth; 
