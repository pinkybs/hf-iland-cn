...
class Hapyfish2_Island_Bll_Island
{
    ...
    public static function initIsland($ownerUid, $uid, $checkPraise = false, $islandId)
    {
        ...
        //owner platform info
        $user = Hapyfish2_Platform_Bll_Factory::getUser($ownerUid);
        //
        ...
        $faceUrl = $user['figureurl'];
        if (strpos($user['figureurl'], 'http://') === false) {
		...
		$islandVo['vipType'] = $vipType;
		$islandVo['vipLevel'] = $vipLevel;
	...
	public static function openIsland($uid, $islandId, $priceType)
	{
		...
		$newIsland = array('2' => array('needLevel' => $newIslandVo['openIsland2Level'], 'needCoin' => $newIslandVo['openIsland2Coin'], 'needGold' => $newIslandVo['openIsland2Gem'], 'needVipGold' => $newIslandVo['openIsland2HZGem'], 'name' => $newIslandVo['IslandName2']),
						   '3' => array('needLevel' => $newIslandVo['openIsland3Level'], 'needCoin' => 99999999999, 'needGold' => $newIslandVo['openIsland3Gem'], 'needVipGold' => $newIslandVo['openIsland3HZGem'], 'name' => $newIslandVo['IslandName3']),
						   '4' => array('needLevel' => $newIslandVo['openIsland4Level'], 'needCoin' => 99999999999, 'needGold' => $newIslandVo['openIsland4Gem'], 'needVipGold' => $newIslandVo['openIsland4HZGem'], 'name' => $newIslandVo['IslandName4']));
        ...
        if ( $islandId == 2 ) {
        	...
        	//$islandInfo['bg_dock_2'] = 25914;
        	//$islandInfo['bg_dock_id_2'] = 14;
        	...
        	//$islandInfo['bg_dock_3'] = 25914;
        	//$islandInfo['bg_dock_id_3'] = 14;
        	//get user next island level
        	...
        	//$islandInfo['bg_dock_4'] = 25914;
        	//$islandInfo['bg_dock_id_4'] = 14;
        	//get user next island level
		...
		$result = Hapyfish2_Island_Bll_QpointBuy::getToken($uid, 1399, array($islandInfo, $openIslandInfo, $userLevelInfo, $islandId, $bgIsland2, $bgIsland3, $bgIsland4));
		return $result;
        }
        else {
			...
			if ($ok2) {
				//add log
				$summary = '开放' . $openIslandInfo['name'];
