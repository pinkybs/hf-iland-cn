...
class Hapyfish2_Island_Dal_BasicInfo
{
    ...
    {
    	$sql = "SELECT level,need_user_level,need_user_level_2,need_user_level_3,need_user_level_4,island_size,max_visitor,gold,cheap_gold,coin FROM island_level_island";
