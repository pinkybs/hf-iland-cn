...
class Hapyfish2_Cache_Feed 
{
  ...
  public function insertMiniFeedday($key, $feed, $time = 604800)
    {
    	$try = 5;
    	$null = null;
    	$ok = false;
...
public function insertIslandMiniFeedday($key, $feed, $time = 604800)
    {
    	if ($feed[1] != 12) {
	    	return;
	    }
    ...
    public function insertPlantManageMiniFeedday($key, $feed, $time = 604800)
    {
    	if ($feed[1] != 13) {
	    	return;
	    }
