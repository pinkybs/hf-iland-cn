...
class Qzone_Rest
{
    ...
    public function getAppFriendIds()
    {
    	...
    	try {
        	...
        	$this->code = $e->getCode();
            err_log('[Qzone_Rest::getAppFriendIds]' . $e->getMessage());
        }
    ...
    public function getPayBalance($needVip = false)
    {
    	...
    	try {
        	...
        	$this->code = $e->getCode();
            err_log('[Qzone_Rest::getPayBalance]' . $e->getMessage());
        }
    ...
    public function isVip()
    {
    	...
    	try {
        	...
        	$this->code = $e->getCode();
            err_log('[Qzone_Rest::isVip]' . $e->getMessage());
        }
    ...
    public function pay($items, $amt)
    {
    	...
    	try {
        	...
        	$this->code = $e->getCode();
            err_log('[Qzone_Rest::pay]' . $e->getMessage());
        }
    ...
    public function payConfirm($billno, $amt=null)
    {
        $this->clearErr();
    	try {
        	...
        	$this->code = $e->getCode();
            err_log('[Qzone_Rest::payConfirm]' . $e->getMessage());
        }
    ...
    public function payCancel($billno, $amt=null)
    {
        $this->clearErr();
    	try {
        	...
        	$this->code = $e->getCode();
            err_log('[Qzone_Rest::payCancel]' . $e->getMessage());
        }
