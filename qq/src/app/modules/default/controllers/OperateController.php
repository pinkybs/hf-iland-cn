...
EOB;
	...
	public function panicupdateAction()
	{
		...
		$dataVo['start_time'] = $startTime;
		$dataVo['end_time'] = $endTime;
		...
		$this->_redirect("operate/panicindex");
	}
	
	public function panicaddnewAction()
	{
		$db = Hapyfish2_Island_Event_Dal_PanicBuy::getDefaultInstance();
		$db->addNewData();
	...
	public function panicstatusAction()
	{
		$id = $this->_request->getParam('id', 1);
