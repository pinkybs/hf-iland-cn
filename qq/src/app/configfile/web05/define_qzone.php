...
define('SERVER_ID', '1005');

define('APP_ID', '610');
define('APP_KEY', '0d726d24360147da8c8079bac1837dfa');
define('APP_NAME', 'island');

define('MEMCACHED_SECTION_NUM', 48);
define('API_HOST', 'http://119.147.79.27');
define('QPOINT_PAY_HOST_GET', 'http://113.108.86.20');
define('QPOINT_PAY_HOST_BUY', 'https://119.147.74.44');

define('HOST', 'http://island.qzone.qzoneapp.com');
define('PENGYOU_HOST', 'http://main.island.qzoneapp.com');
define('QZONE_HOST', 'http://island.qzone.qzoneapp.com');
define('STATIC_HOST', 'http://imgcache.qzoneapp.com/island');
...
define('PLATFORM_SOURCE', '1');//1 Qzone  2 pengyou