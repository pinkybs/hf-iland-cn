...
class Hapyfish2_Island_Cache_Counter
{
    ...
    // 获得好友帮助
    public static function getBottleFriendHelpTF($uid)
    {
    	$key = 'bottle:friendhelp:8hourtf:' . $uid;
    ...
    // 更新好友帮助
    public static function updateBottleFriendHelpTF($uid)
    {
    	$key = 'bottle:friendhelp:8hourtf:' . $uid;
        ...
        return $cache->add($key, 1, 3600*8);
    }
    
    // 清除 
    public static function clearBottleFriendHelpTF($uid) 
    {
    	$key = 'bottle:friendhelp:8hourtf:' . $uid;
    	$cache = Hapyfish2_Cache_Factory::getMC($uid);
