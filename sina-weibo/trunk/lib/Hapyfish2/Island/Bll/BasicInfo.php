...
class Hapyfish2_Island_Bll_BasicInfo
{
	...
	public static function getInitVo()
	{
        ...
        /*$resultInitVo['SVDemandClass'] = self::getSVDemandList();
        $resultInitVo['SVVisitorClass'] = self::getSVisitorList();
        $resultInitVo['SVCollectionClass'] = self::getCollectionList();
        $resultInitVo['SVCollectionGroups'] = self::getCollectionGroups();*/
