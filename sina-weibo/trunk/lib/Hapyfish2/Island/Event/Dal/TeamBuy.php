...
class Hapyfish2_Island_Event_Dal_TeamBuy
{
     ...
     * join team buy,temp
     */
    public function insertTeamBuyUserTemp($uid, $status)
    {
        $sql = "INSERT INTO `island_user_teambuy_temp`(uid, status) VALUES (:uid, :status)";
    ...
    /**
     * select team buy,temp
     */
    public function selectTeamBuyUserTemp($uid)
    {
        $sql = "SELECT uid FROM `island_user_teambuy_temp` WHERE uid=:uid";
