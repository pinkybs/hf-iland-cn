...
class Hapyfish2_Island_Event_Bll_Christmas
{
	...
	public static function christmasinit($uid)
	{
		...
		$mapOneTime = strtotime('2012-01-03 23:59:59');
		$mapTwoTime = strtotime('2012-01-03 23:59:59');
		$mapThreeTime = strtotime('2012-01-03 23:59:59');
	...
	public static function christmasGetPlant($uid)
	{
		...
		$list = array(130532, 130632, 130732, 130832, 131032);
