...
class Hapyfish2_Island_Dal_Dock
{
    ...
    public function init($uid)
    {
        ...
        $time = $now - 1200;
    	$tbname = $this->getTableName($uid);
        $sql = "INSERT INTO $tbname(uid, position_id, receive_time, start_visitor_num) VALUES(:uid, 1, $time, 5),(:uid, 2, $time, 5),(:uid, 3, $now, 5)";
    ...
    public function getUserDockData($uid)
    {
		$tbname = $this->getTableName($uid);
    	$sql = "SELECT position_id,unlock_ship_ids FROM $tbname WHERE uid=:uid";
