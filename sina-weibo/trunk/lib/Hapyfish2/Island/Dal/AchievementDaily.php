...
class Hapyfish2_Island_Dal_AchievementDaily
{
     ...
     * Single Instance
     *
     * @return Hapyfish2_Island_Dal_AchievementDaily
     */
    ...
    public function getTableName($uid)
    {
    	...
    	return 'island_user_achievement_daily_' . $id;
    }

    public function get($uid)
    {
        $tbname = $this->getTableName($uid);
    	$sql = "SELECT today,num_1,num_2,num_3,num_4,num_5,num_6,num_7,num_8,num_9,num_10 FROM $tbname WHERE uid=:uid";
