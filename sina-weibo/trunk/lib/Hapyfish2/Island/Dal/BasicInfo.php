...
class Hapyfish2_Island_Dal_BasicInfo
{
    ...
    {
    	$sql = "SELECT level,need_user_level,island_size,max_visitor,gold,coin FROM island_level_island";
    ...
    {
    	$sql = "SELECT id,title,position,priority,link,opened,create_time FROM island_notice WHERE opened=1 ORDER BY position ASC,create_time DESC,priority ASC";
